...
function TranslateComponent() {
  ...
  return (
    <div className="min-h-screen bg-[#072a34] flex items-center justify-center p-4 sm:p-6 md:p-8">
  ...
  <div className="flex-1 relative">
    <textarea
      className="w-full h-[170px] p-4 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 resize-none transition duration-200 bg-gray-50"
      rows="8"
      value={input}
      onChange={(e) => setInput(e.target.value)}
      placeholder="Nhập từ bạn muốn dịch, vd: Hello"
    ></textarea>
    <button
  ...
  <div className="flex-1 relative">
    <textarea
      className="w-full h-[170px] p-4 bg-gray-100 border border-gray-300 rounded-lg focus:outline-none resize-none transition duration-200"
      rows="8"
      value={output}
      readOnly
    ...
    >
      ...
      className='text-black text-2xl' />
        ...
        <div className="mt-8 text-center">
          <button
            className="bg-blue-900 font-bold hover:bg-blue-400 text-white px-8 py-3 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50 transition duration-200 transform hover:scale-105 shadow-md"
            onClick={translate}
          >
            Dịch Ngay
          </button>
      ...
      <p className='absolute bottom-0 mb-[10px] text-white font-bold text-[16px] lg:text-2xl'>&copy; Mọi Bản Quyền Thuộc về Huỳnh Vĩnh Tiến</p>
    </div>
  );
}
